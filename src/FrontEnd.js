...
export class OptionParser extends OptionParserBase {
	...
	const True = true;
	const False = false;
	const     thresholds = {'info': 1, 'warning': 2, 'error': 3, 'severe': 4, 'none': 5}
	const     booleans={'1': True, 'on': True, 'yes': True, 'true': True,
	...
	this.settingsSpec = [ 'General Docutils Options',
         ...
         ['Do not include a datestamp of any kind.',
          ['--no-datestamp'], {'action': 'store_const', 'const': null,
                               'dest': 'datestamp'}],
         ...
         ['Enable Python tracebacks when Docutils is halted.',
          ['--traceback'], {'action': 'store_true', 'default': null,
                            'validator': validate_boolean}],
         ...
         ['Write output file dependencies to <file>.',
          ...
          {'metavar': '<file>', 'validator': validate_dependency_file,
           'default': null}],           // default set in Values class
